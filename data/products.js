...
export const BLOG_POSTS = [
  { id: 1, title: "Essential travel packing tips for fashion lovers", category: "Life Style", cat: "Life Style", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a23412389ab.jpg", description: "Stay stylish and organized on your trips with these smart packing hacks.", excerpt: "Stay stylish and organized on your trips with these smart packing hacks." },
  { id: 2, title: "The psychology of colors in fashion", category: "Fashion", cat: "Fashion", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a23425123cd.jpg", description: "Learn how the colors you wear influence mood, confidence, and perception.", excerpt: "Learn how the colors you wear influence mood, confidence, and perception." },
  { id: 3, title: "Gift ideas for every budget from affordable to luxury", category: "Life Style", cat: "Life Style", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a2343890ef.jpg", description: "Find the perfect gift without breaking the bank, our ideas suit every budget.", excerpt: "Find the perfect gift without breaking the bank, our ideas suit every budget." },
  { id: 4, title: "A beginner's guide to home fragrances", category: "Business", cat: "Business", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a2345678ab.jpg", description: "Learn how scents can transform your home atmosphere and boost your mood.", excerpt: "Learn how scents can transform your home atmosphere and boost your mood." },
  { id: 5, title: "Must-have accessories to elevate your everyday look", category: "Business", cat: "Business", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a234789012.jpg", description: "Small details make a big difference discover the top accessories you need right now.", excerpt: "Small details make a big difference discover the top accessories you need right now." },
  { id: 6, title: "Why sustainable fashion matters more than ever", category: "Fashion", cat: "Fashion", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a234901234.jpg", description: "Understand the importance of eco-friendly choices in fashion and how you can make a difference.", excerpt: "Understand the importance of eco-friendly choices in fashion and how you can make a difference." },
  { id: 7, title: "How to pick the right shoes for comfort and style", category: "Fashion", cat: "Fashion", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a234b56789.jpg", description: "Find out how to balance fashion and comfort when choosing your footwear.", excerpt: "Find out how to balance fashion and comfort when choosing your footwear." },
  { id: 8, title: "How to choose the perfect outfit for every occasion", category: "Life Style", cat: "Life Style", time: "2 months ago", image: "https://modesy.codingest.net/uploads/blog/blog_64a234c89012.jpg", description: "Learn how to style yourself with the right outfit for casual, formal, and special events.", excerpt: "Learn how to style yourself with the right outfit for casual, formal, and special events." },
];

export const SLIDES = [
  {
    title: "Buy Nice and Unique Clothes",
    sub: "Discover quality premium basics and trendy essentials at surprisingly affordable prices",
    cta: "Explore Now",
    image: "https://odykmbdferwvcgtxzzpe.supabase.co/storage/v1/object/public/products/slider_2560x800_6a94336760c054-95358530.webp",
  },
  {
    title: "Find Backpacks That Best Suit You",
    sub: "Timeless, modern, and feminine pieces made with quality materials and craftsmanship",
    cta: "Buy Now",
    image: "https://odykmbdferwvcgtxzzpe.supabase.co/storage/v1/object/public/products/slider_2560x800_6a9434c4d28763-19000658.webp",
  },
];
